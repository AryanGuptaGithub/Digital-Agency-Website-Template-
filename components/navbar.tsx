...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    const onScroll = () => {
      ...
      /* Show navbar once hero reaches ~55% */
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-40 flex flex-col items-center justify-center bg-black/90 backdrop-blur-2xl backdrop-blur-3xl"
          >
